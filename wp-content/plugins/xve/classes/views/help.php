...
<p>
	<?php printf(__xve('<strong>Usage mode:</strong> [service-type]http://example.com/permalink[/service-type], where the service-type is one of the following: %s. The URL must point to either an external service, or to a SWF / FLV / MP4 file.'), implode(', ', $types)) ?>
</p>
<p>
